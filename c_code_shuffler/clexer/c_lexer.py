...
class CLexer(object):
    """ A lexer for the C language. After building it, set the
        ...
        directives.
    """
    def __init__(self, error_func = None, on_lbrace_func = None, on_rbrace_func = None,
        ...
        """
        self.error_func = error_func or (lambda m,l,c: None)
        self.on_lbrace_func = on_lbrace_func or (lambda: None)
        self.on_rbrace_func = on_rbrace_func or (lambda: None)
        self.type_lookup_func = type_lookup_func or (lambda _: True)
        self.filename = ''
